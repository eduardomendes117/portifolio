    ...
    <>
      ...
      <section className="flex flex-col justify-center bg-black w-svw py-16 xl:py-20 !h-full" id="projects">
        <div className="flex justify-center mb-5">
          <a
            class="rounded-full w-full max-w-xs border border-solid border-slate-600 transition-colors flex items-center justify-center gap-3 hover:border-white bg-black hover:bg-black/90 hover:border-transparent text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5"
